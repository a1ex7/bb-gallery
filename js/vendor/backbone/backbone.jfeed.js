...
(function() {
  ...
  Backbone.JFeed.Collection = Backbone.Collection.extend({
    fetch: function(options) {
      if (!this.feedUrl && !this.options.feedUrl) throw new Error('A "feedUrl" property must be specified');
      options || (options = {});
      var collection = this;
      ...
      return $.getFeed(_.extend({ url: this.feedUrl || this.options.feedUrl}, options))
    }
  });
